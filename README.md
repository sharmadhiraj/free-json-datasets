...
- [**Annual Book Publishing by Country**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/arts-literature/books_published_per_country_per_year.json)  
...
- [**Top Stock Exchange Companies by Market Cap**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/economy-finance/largest_stock_exchanges_by_market_cap.json)  
  Ranking of major global stock exchange operators by market capitalization.
...
- [**Remittances Received by Country**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/economy-finance/list_of_countries_by_remittances_received.json)  
  Annual remittances received by each country in USD millions and percentage of GDP
...
- [**Research & Innovation Rankings**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/education-knowledge/research_and_innovation_rankings.json)  
  Global universities and institutions ranked by research output, innovation, and impact [SCImago]
...
- [**Major Oil Fields of the World**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/energy-industry/list_of_oil_fields.json)  
  Oil fields with estimated ultimate recoverable reserves exceeding 1 billion barrels
...
- [**Major Epidemics and Pandemics**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/health-medicine/major_epidemics_and_pandemics.json)  
  Global outbreaks with over 1 million deaths
- [**Obesity Rates by Country (WHO, 2022)**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/health-medicine/obesity_rates_by_country.json)  
  Percentage of adults classified as obese (BMI ≥ 30 kg/m²), based on WHO data, including total, male, and female obesity rates.
...
- [**World’s Highest-Paid Athletes (2025)**](https://github.com/sharmadhiraj/free-json-datasets/blob/master/docs/sports-entertainment/highest_paid_athletes.json)  
  Top athletes ranked by total earnings, salary, and endorsements in 2025.
